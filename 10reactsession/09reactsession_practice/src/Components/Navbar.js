...
const Navbar = ({movieList,setMovieList,filterMovieList, setfilterMovieList,mode,setMode}) => {
  // console.log(mode)
  ...
  useEffect(() => {
    console.log("Hello,call this when there is an change in the dependancy")
    getMovies()     
  }, [searchText])
   
  async function getMovies(){
   const data=await fetch('https://63e4b3c5c04baebbcdaa0ebb.mockapi.io/movies')
   const json=await data.json()
   console.log(json)
   setMovieList(json)
   setfilterMovieList(json)
  }
